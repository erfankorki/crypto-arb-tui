...
export const Prices = () => {
    ...
    const nobitexPricesQuery = pricesQueryFactory({ exchange: 'nobitex', market: 'BTCUSDT' });
    const tabdealPricesQuery = pricesQueryFactory({ exchange: 'tabdeal', market: '2' });
    const bitpinPricesQuery = pricesQueryFactory({ exchange: 'bitpin', market: '2' });
